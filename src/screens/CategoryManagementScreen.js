...
const CategoryManagementScreen = () => {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const categoriesRes = await adminAPI.getAllCategories();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'error',
        text1: 'Error',
        text2: error.response?.data?.error || 'Failed to save category',
      });
    }
  };
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      Toast.show({
        type: 'error',
        text1: 'Error',
        text2: error.response?.data?.error || error.response?.data?.message || error.message || 'Failed to delete category',
      });
    } finally {
      setLoading(false);
    }
  ...
  if (loading) {
    return (
      <View style={styles.container}>
        <Header title="Categories" showSearch={false} showCart={false} />
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <TouchableOpacity style={styles.emptyButton} onPress={handleAdd}>
              <Text style={styles.emptyButtonText}>Add Your First Category</Text>
            </TouchableOpacity>
          </View>
        }
      />
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                style={styles.input}
                placeholder="e.g., CCTV, Networking, Access Controls"
                value={formData.name}
            ...
            <View style={styles.formGroup}>
              ...
              <TextInput
                style={styles.input}
                placeholder="e.g., videocam, wifi, shield-checkmark"
                value={formData.icon || ''}
